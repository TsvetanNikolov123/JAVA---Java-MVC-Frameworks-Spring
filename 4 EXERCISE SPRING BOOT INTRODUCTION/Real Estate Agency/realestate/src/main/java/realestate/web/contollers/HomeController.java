package realestate.web.contollers;
    ...
    private String prepareHtml() throws IOException {
        ...
        if (offers.size() == 0) {
            offersHtml
                    ...
                    .append("</div>");
            return this.reader.readHtmlFile("C:\\OneDrive\\Java\\Java WEB\\Java MVC Frameworks - Spring\\4 EXERCISE SPRING BOOT INTRODUCTION\\Real Estate Agency\\realestate\\src\\main\\resources\\static\\index.html")
